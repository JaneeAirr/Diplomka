...
import SidenavCollapse from "examples/SideNav_admin/SidenavCollapse";
import SidenavCard from "examples/SideNav_admin/SidenavCard";
import SidenavRoot from "examples/SideNav_admin/SidenavRoot";
...
function SidenavAdmin({ color, brandName, ...rest }) {
