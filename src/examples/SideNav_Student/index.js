...
import SidenavCollapse from "examples/SideNav_Student/SidenavCollapse";
import SidenavCard from "examples/SideNav_Student/SidenavCard";
import SidenavRoot from "examples/SideNav_Student/SidenavRoot";
...
import {  studentRoutes as routes } from "routes";

function SidenavStudent({ color, brandName, ...rest }) {
...
SidenavStudent.defaultProps = {
  color: "info",
};

SidenavStudent.propTypes = {
